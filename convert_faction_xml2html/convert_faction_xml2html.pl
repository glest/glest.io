...
$footer =~ s/VAR_CREATED_BY/<I><A HREF=\"https:\/\/github.com\/Glest\/glest.io\/blob\/master\/convert_faction_xml2html\/convert_faction_xml2html.pl\">$me<\/A><\/I>, version: <I>$version<\/I>, using config-file:  <I>$cfg_file<\/I>/;
